...
const tabs = [
  { name: 'Отделы', component: DepartmentsView, color: 'bg-indigo-100 text-indigo-700 hover:bg-indigo-200' },
  ...
  <div class="w-full p-4 min-h-screen bg-gray-50">
    <div class="flex flex-wrap gap-2 mb-6">
      ...
      >
        ...
        <svg v-if="activeTab === index" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
...
.ring-slate-500 { --tw-ring-color: #64748b; }
</style>